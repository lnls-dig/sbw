...
chdrift_level = 1e-2;               % Channel gain drift peak-to-peak [ratio]

% Signal amplitude variation [ratio]
bcd_factor = 0.4;                   % Long-range BCD
...
rffe_poly = [-1.152 0 1 0]*10;      % TAMP-72LN amplifier (only last stage taken into account for simplicity)
